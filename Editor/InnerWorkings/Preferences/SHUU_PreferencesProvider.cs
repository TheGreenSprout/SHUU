...
namespace SHUU._Editor.InnerWorkings
{
    public class SHUU_PreferencesProvider : SettingsProvider
    {
        ...
        [SettingsProvider]
        public static SettingsProvider CreateProvider() => new SHUU_PreferencesProvider("Project/SHUU", SettingsScope.Project);
        #endregion
