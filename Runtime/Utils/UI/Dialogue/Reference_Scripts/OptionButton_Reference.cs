...
namespace SHUU.Utils.UI.Dialogue
{
    ...
    public class OptionButton_Reference : MonoBehaviour
    {
        private RectTransform parent;

        private Vector2Int index_count = Vector2Int.zero;



        [SerializeField] private AutomaticSpacingStyles automaticSpacingStyle = AutomaticSpacingStyles.Grid_2Row;
        ...
        private void Awake()
        {
            ...
            index_count = Vector2Int.zero;
        }


        public virtual void Appear(string label, Action action, Vector2Int indexCount)
        {
        ...
        public virtual void ButtonWasAdded()
        {
            index_count.y++;
        ...
        public virtual void ButtonWasRemoved()
        {
            index_count.y--;
        ...
        {
            if (automaticSpacingStyle == AutomaticSpacingStyles.None || parent == null || index_count.y <= 0) return;


            int index = index_count.x;
            int count = index_count.y;
