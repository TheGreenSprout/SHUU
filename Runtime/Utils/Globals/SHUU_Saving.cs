...
namespace SHUU.Utils.Globals
{
    ...
    public class SHUU_Saving : MonoBehaviour
    {
        ...
        #endregion
        public static bool LoadSingletonInfoFromFile() => Persistant_Globals.saveFilesManager.LoadJsonInfo();
        ...
        {
            int i = Persistant_Globals.saveFilesManager.currentSaveFileIndex;
        ...
        #region Misc
        public static void Change_CurrentSaveFileIndex(int changeIndex) => Persistant_Globals.saveFilesManager.currentSaveFileIndex += changeIndex;

        public static void Override_CurrentSaveFileIndex(int newIndex) => Persistant_Globals.saveFilesManager.currentSaveFileIndex = newIndex;
        #endregion
    }
