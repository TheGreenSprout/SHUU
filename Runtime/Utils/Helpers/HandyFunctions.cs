...
namespace SHUU.Utils.Helpers
{
    ...
    public static class HandyFunctions
    {
        ...
        public static SettingsData GetSettingsData(string name) => SettingsTracker.instance?.tracked_settingsData.Find(x => x.settingsName == name);


        public static bool GetBool(this SettingsData data, string key) => data.fields.Find(x => x.key == key)?.boolValue ?? false;

        public static int GetInt(this SettingsData data, string key) => data.fields.Find(x => x.key == key)?.intValue ?? 0;

        public static float GetFloat(this SettingsData data, string key) => data.fields.Find(x => x.key == key)?.floatValue ?? 0f;

        public static string GetString(this SettingsData data, string key) => data.fields.Find(x => x.key == key)?.stringValue ?? "";


        public static bool SetField(this SettingsData data, string key, object value)
        {
            var field = data.fields.Find(x => x.key == key);
        ...
        public static bool SetBool(this SettingsData data, string key, bool value)
        {
            var field = data.fields.Find(x => x.key == key && x.type == SettingType.Bool);
            if (field == null) return false;
        ...
        public static bool SetInt(this SettingsData data, string key, int value)
        {
            var field = data.fields.Find(x => x.key == key && x.type == SettingType.Int);
            if (field == null) return false;
        ...
        public static bool SetFloat(this SettingsData data, string key, float value)
        {
            var field = data.fields.Find(x => x.key == key && x.type == SettingType.Float);
            if (field == null) return false;
        ...
        public static bool SetString(this SettingsData data, string key, string value)
        {
            var field = data.fields.Find(x => x.key == key && x.type == SettingType.String);
            if (field == null) return false;
