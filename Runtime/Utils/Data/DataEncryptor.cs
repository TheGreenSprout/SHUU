...
namespace SHUU.Utils.Data
{
    ...
    public static class EncryptionBasics
    {
        ...
        #endregion
        public static List<string> GetEncryptionPrefixes() => new List<string>{"AES_", "RSA_", "B64_"};
        ...
        #endregion
        public static string GetEncryptionPrefixByEnum(EncryptionTypes encryptionType) => GetEncryptionPrefixes()[(int) encryptionType];
        ...
        #endregion
        public static byte[] GetBytesOfString(string data) => Encoding.UTF8.GetBytes(data);
            ...
            using (Aes aes = Aes.Create())
            {
                ...
                using (MemoryStream ms = new MemoryStream())
                {
                    ...
                    using (CryptoStream cs = new CryptoStream(ms, aes.CreateEncryptor(aes.Key, aes.IV), CryptoStreamMode.Write))
                    {
                        ...
                        if (addPrefix) retS = EncryptionBasics.GetEncryptionPrefixByEnum(EncryptionTypes.AES) + retS;
    ...
    public static class RSA_Encryption
    {
        ...
        public static string EncryptString(string stringToEncrypt, string publicKey, bool addPrefix)
        {
            using (RSACryptoServiceProvider rsa = new RSACryptoServiceProvider(2048))
            {
                ...
                if (addPrefix) retS = EncryptionBasics.GetEncryptionPrefixByEnum(EncryptionTypes.RSA) + retS;
    ...
    public static class BASE64_Encryption
    {
        ...
        public static string EncryptString(string stringToEncrypt, bool addPrefix){
            ...
            if (addPrefix) retS = EncryptionBasics.GetEncryptionPrefixByEnum(EncryptionTypes.BASE64) + retS;
